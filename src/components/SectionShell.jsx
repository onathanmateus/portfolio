...
export function SectionShell({ children, prev, next }) {
  return (
    <motion.main
      ...
      className="min-h-[100svh] pt-28 pb-8"
    >
      {children}

      <nav className="mx-auto mt-12 flex max-w-5xl items-center justify-between gap-4 px-5 font-mono text-xs uppercase tracking-wider sm:px-6">
